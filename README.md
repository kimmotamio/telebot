...
[![GoDoc](https://godoc.org/github.com/kimmotamio/telebot/v3?status.svg)](https://godoc.org/github.com/kimmotamio/telebot/v3)
...
```bash
go get -u github.com/kimmotamio/telebot/v3
```
...
import (
	...
	tele "github.com/kimmotamio/telebot/v3"
)
...
[here](https://godoc.org/github.com/kimmotamio/telebot/v3#pkg-constants).
...
```go
import "github.com/kimmotamio/telebot/v3/middleware"
```
...
[here](https://pkg.go.dev/github.com/kimmotamio/telebot/v3#Option).
