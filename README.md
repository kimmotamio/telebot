...
[![GoDoc](https://godoc.org/github.com/kimmotamio/telebot?status.svg)](https://godoc.org/github.com/kimmotamio/telebot)
...
```bash
go get -u github.com/kimmotamio/telebot
```
...
import (
	...
	tele "github.com/kimmotamio/telebot"
)
...
[here](https://godoc.org/github.com/kimmotamio/telebot#pkg-constants).
...
```go
import "github.com/kimmotamio/telebot/middleware"
```
...
[here](https://pkg.go.dev/github.com/kimmotamio/telebot#Option).
